...
namespace Problem1
{
    ...
    public partial class Method1
    {
        ...
        private readonly List<EventList> _eventList; 
        public Method1(EventList dataList1, EventList dataList2, EventList dataList3)
        {
            InitializeComponent();
            _eventList = new List<EventList> {dataList1, dataList2, dataList3};
        }
        ...
        private void FillDataTable(ref DataTable table,int eventIndex)
        {
            ...
            foreach (var elemet in tempList)
            {
                ...
                table.Rows.Add(new object[]
                                   {counter, elemet.Item1, elemet.Item2, elemet.Item3, elemet.Item4, elemet.Item5});
                counter++;
            }
        }
        ...
        private void WindowActivated(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var reader = new StreamReader(new FileStream(@"Templates\ReportTemplate.xaml", FileMode.Open, FileAccess.Read));
